...
#include "VersionPakBPLibrary.generated.h"
...
UCLASS()
class VERSIONPAK_API UVersionPakBPLibrary : public UBlueprintFunctionLibrary
{
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, meta = (DisplayName = "GetPakInfo", Keywords = "IFO"), Category = "VersionUpdate")
	static void InitConfig(const FVersionPakConfig& InConfig);
	...
	*/
	UFUNCTION(BlueprintPure, meta = (DisplayName = "GetMountedFilenames", Keywords = "PakInfo"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (Keywords = "FF"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (Keywords = "M"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (Keywords = "UM"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "OB"), Category = "VersionUpdate")
	...
	* @Filename				The file format is similar to the following ："/Game/Mesh/YourAssetName" .
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "GC"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "GM"), Category = "VersionUpdate")
	...
	* @Type					Is the resource type patch or DLC ..
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "GT"), Category = "VersionUpdate")
	...
	* @Type					Is the resource type patch or DLC ..
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "GS"), Category = "VersionUpdate")
	...
	* @Type					Is the resource type patch or DLC ..
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "GSM"), Category = "VersionUpdate")
	...
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "OB", Category = "VersionUpdate", WorldContext = "WorldContextObject"))
	...
	* @InRotator			A character needs a rotation default .
	*/
	UFUNCTION(BlueprintPure, meta = (Keywords = "UMGWidget", Category = "VersionUpdate", WorldContext = "WorldContextObject"))
