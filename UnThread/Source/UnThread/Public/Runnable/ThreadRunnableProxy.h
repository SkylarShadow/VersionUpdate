...
class UNTHREAD_API FThreadRunnable : public FRunnable, public IThreadProxy
{
public:
...
private:
	...
	FUnSemaphore					ThreadEvent;     //Semaphore blocking thread 
	FUnSemaphore					StartUpEvent;	 //Semaphore block start thread 
	FUnSemaphore					WaitExecuteEvent;//Semaphore suspend start thread 
